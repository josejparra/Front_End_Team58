...
with open(GEODATA_PATH.joinpath("Pol_Veredas.json")) as geofile:
...
layout = html.Div([
    html.H2('Geographical Analysis', style={"textAlign": "left"}),
    ...
    html.H3('Commerce Tax', style={"textAlign": "center"}),
    html.Div(
...
def display_RionegroPREDIAL(id_chosen):
    ...
    fig = px.choropleth_mapbox(df_fltrd,geojson=j_file, locations='id', color='Val',
                           color_continuous_scale="Viridis",
                           mapbox_style="carto-positron",
                           zoom=12, center = {"lat": 6.1508, "lon": -75.3775},
                           opacity=0.5,
